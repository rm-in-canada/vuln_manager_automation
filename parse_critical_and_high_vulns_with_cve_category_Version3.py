...
# Read data, skipping the first row (need to input CSV name when you run the script)
import argparse

parser = argparse.ArgumentParser(description='Process vulnerability CSV file.')
